...
urlpatterns = [
    ...
    path('issueCategoryRegisterPage/', views.issueCategoryRegisterPage , name="issueCategoryRegisterPage"),
    path('issueRegisterPage/', views.issueRegisterPage , name="issueRegisterPage"),
    path('updateManagerIssue/<str:pk>/', views.updateManagerIssue , name="updateManagerIssue"),
